...
public class BoardManager  {
	...
	public void EditOrPlacePiece(Vector2 mousePosClick)
	{
		...
		else if(Input.GetKey(KeyCode.A))
		{
			if(pieceBoard[(int)vecRoundToInt.x, (int)vecRoundToInt.y] == null)
			{
				pieceBoard [(int)vecRoundToInt.x, (int)vecRoundToInt.y] = GameObject.Instantiate (movablePiece, new Vector2 ((int)vecRoundToInt.x, (int)vecRoundToInt.y), Quaternion.identity);
			}
		}
		else if(Input.GetKey(KeyCode.S))
		{
			if(pieceBoard[(int)vecRoundToInt.x, (int)vecRoundToInt.y] == null)
			{
				pieceBoard [(int)vecRoundToInt.x, (int)vecRoundToInt.y] = GameObject.Instantiate (staticPiece, new Vector2 ((int)vecRoundToInt.x, (int)vecRoundToInt.y), Quaternion.identity);
			}
		}
		else if(Input.GetKey(KeyCode.D))
		{
			if(pieceBoard[(int)vecRoundToInt.x, (int)vecRoundToInt.y] == null)
			{
				pieceBoard [(int)vecRoundToInt.x, (int)vecRoundToInt.y] = GameObject.Instantiate (mainPiece, new Vector2 ((int)vecRoundToInt.x, (int)vecRoundToInt.y), Quaternion.identity);
			}
		}
	}
}
